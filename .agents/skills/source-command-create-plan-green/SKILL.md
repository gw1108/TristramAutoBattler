---
name: "source-command-create-plan-green"
...
# source-command-create-plan-green

Use this skill when the user asks to run the migrated source command `create_plan_green`.
