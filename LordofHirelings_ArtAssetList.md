...
4. **The Gilded shader has no tech spec yet.** The Hoarder treatment has `LordofHirelings_HoarderFattenTech.md`; the Gilded gold-remap + glint shader needs a parallel write-up (remap curve, glint period, sparkle density) when implementation starts. The visual target is documented in its section 2 row.
