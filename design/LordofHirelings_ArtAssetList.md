...
| Pixel font | All UI text, floating combat text, prompts. | Pixel Operator regular and bold, CC0 1.0. The included source files live in `lord-of-hirelings/source-assets/fonts/pixel-operator/`; bold is reserved for CRIT and other high-attention text. | MVP |
